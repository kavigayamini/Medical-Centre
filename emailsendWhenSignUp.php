...
if (isset($_POST['register_btn'])) {
 ...
 $username = $_POST['username'];
  ...
  <body>
        <h4 style='color:darkblue;font-family:calibri;font-size:15px;'> ***Your Account Details in Private Medical Center Kalutara is Successfully Created*** </h4>
        ...
        <h5 style='color:red;font-family:calibri;font-size:15px;'> *****Don't forget your Username and Password and Please verify if your account is not Verified***** </h5>
