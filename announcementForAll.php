...
if (isset($_POST['emailForAll'])) {
    ...
    <body>
        <h1>Announcment from Private Medical Center Kalutara </h1>
        <h1>" . $subject . "</h1>
        <p>".$msg."</p>
        <p>From:llllllllll</p>
    </body>
...
<div class="row animated fadeIn">
    <img src="img/allUsers.jpg" class="img-fluid" alt="Responsive image">
</div>
<br><br>
...
<div class="container-fluid">
    <div class="row ">
        ...
        <div class=" col-md-8">
            <H4> Enter Message to Send to the all Users in System</h4><br>
<form method="post" action="announcementForAll.php" >
               ...
               <div class="form-group">
						 	...
						 	<div class="form-group">
						 		<button type="submit" class="btn btn-raised btn-block btn-danger" name="emailForAll" >Announcement For All</button>
						 	</div>
                        </form>
