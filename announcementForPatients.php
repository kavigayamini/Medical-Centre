...
if (isset($_POST['emailForPat'])) {
  ...
  $sql3 = "SELECT email FROM users WHERE user_type='user'";
...
$to = implode(", ", $addresses);
                ...
                $_SESSION['mail']  = "Your message has been sent to the Patients Successfully!";
...
<div class="row animated fadeIn">
    <img src="img/allPatients.jpg" class="img-fluid" alt="Responsive image">
</div>
<br><br>
...
<div class="container-fluid">
    <div class="row ">
        ...
        <div class=" col-md-8">
            <H4> Enter Message to Send to the all Patients who are registered in System</h4><br>
<form method="post" action="announcementForPatients.php" >
               ...
               <div class="form-group">
						 	...
						 	<div class="form-group">
						 		<button type="submit" class="btn btn-raised btn-block btn-danger" name="emailForPat" >Announcement For Patients</button>
						 	</div>
                        </form>
